...
const detailPage = {
    render: async (id) => {
        ...
        <div class="bg-white">
                ...
                <div class="lg:grid lg:grid-cols-2 lg:gap-x-8 lg:items-start">
                    ...
                    <div class="hidden mt-6 w-full max-w-2xl mx-auto sm:block lg:max-w-none">
                        ...
                        <button id="tabs-1-tab-1" class="relative h-24 bg-white rounded-md flex items-center justify-center text-sm font-medium uppercase text-gray-900 cursor-pointer hover:bg-gray-50 focus:outline-none focus:ring focus:ring-offset-4 focus:ring-opacity-50" aria-controls="tabs-1-panel-1" role="tab" type="button">
                            ...
                            <img src="${data.image}" width="70%" height="100%" alt="" class=" object-center object-cover">
                            </span>
                        </button>
                    ...
                    <div class="w-full aspect-w-1 aspect-h-1">
                        ...
                        <img src="${data.image}" width="70%" height="100%" alt="Angled front view with bag zipped and handles upright." class=" object-center object-cover sm:rounded-lg">
                        </div>
                        <!-- More images... -->
                    </div>
                    </div>
                    ...
                    <h1 class="text-3xl font-extrabold tracking-tight text-gray-900">${data.name}</h1>
            
                    <div class="mt-3">
                        <p class="text-3xl text-red-600">${data.saleOffPrice}</p>
                        <p class="text-xl text-gray-400">${data.originalPrice}</p>
                    </div>
                    <div class="mt-6">
                        ...
                        <div class="mt-40 flex sm:flex-col1">
                        <button type="submit" style="background:blue" class="max-w-xs flex-1 bg-indigo-600 border border-transparent rounded-md py-3 px-8 flex items-center justify-center text-base font-medium text-white hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-50 focus:ring-indigo-500 sm:w-full">Add to bag</button>
                        </div>
            ...
            <div class="product ">
                <h1 class="ml-20 mt-10 text-lg ">SẢN PHẨM LIÊN QUAN</h1>
                <div class="grid grid-cols-5 gap-6 m-10">
                <div>
                    <img src="${data.image}" width="180px" height="50px" class="mb-2" alt="">
